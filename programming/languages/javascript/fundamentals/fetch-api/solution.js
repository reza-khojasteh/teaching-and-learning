// Functions declared with the async keyword allow us to write asynchronous code in a synchronous manner. And together with the Fetch API, we can make asynchronous API requests.
