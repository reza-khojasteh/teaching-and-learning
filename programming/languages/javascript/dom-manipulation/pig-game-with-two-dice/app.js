...
- ALSO IN THIS EDITION: Add another dice to the game, so that there are two dices now; a player looses their current score when (at least) one of them is a 1. 
...
document.querySelector('.btn-roll').addEventListener('click', function () {
    ...
    if (gamePlaying) {
        // 1. Generate two random numbers between 1 and 6 for the two dice
        ...
        document.getElementById('dice-2').classList.remove('fade-out');

        // 3. Display the result based on the random values generated
        ...
        // 4. IF any of the rolled numbers were NOT a 1, update the roundScore 
        if (dice1 !== 1 && dice2 !== 1) {
            ...
            nextPlayer();
            //Show the display, just for this special case, as at least one of the dice have been 1!
            document.getElementById('dice-1').style.display = 'block';
            document.getElementById('dice-2').style.display = 'block';
            //Mention that the current score is gone due to the 'Dice 1'!
            ...
            document.getElementById('dice-2').classList.add('fade-out');
        }
    }
});
