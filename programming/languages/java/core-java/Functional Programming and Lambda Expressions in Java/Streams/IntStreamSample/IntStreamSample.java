...
* 1- simply returns a sequential ordered stream whose elements are the specified values - using of(1, 2, 3), 
...
* 3- and finally, performs an action (printing here) for each element of this stream.
*
